...
pro microにファームウェアを入れて、仮にキーキャップをソケットに差し込んで、
キースイッチを打鍵した時に反応するかどうか、確認してください。
打鍵したけど、入力されない時は、ダイオードの向きが間違っていないか、
ソケットのハンダ付けが外れていないか等が原因になります。テスターで導通を確認してください。
入力確認には、次のサイトがお勧めです。
...
特に右側のミドルプレート１は形状的に破損しやすいですので、注意して取り扱ってください。<br>
次にミドルプレート２を重ねます。
...
これで完成です。自分だけのcool950Sができましたか。<br>
